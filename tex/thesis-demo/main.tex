...
Kod źródłowy rozwiązania jest dostępny na repozytorium w~serwisie GitHub\footnote{\url{https://github.com/aleksandrakyc/kanji-learning-app}}, a~panel administratora można odwiedzić na stronie internetowej\footnote{\url{https://kanjilearningapp-e002b.web.app/}} i~zalogować się loginem \texttt{admin@adminland.pl} i~hasłem \texttt{admin123}. 
\backmatter
...
\printbibliography[heading=subsubbibnumbered, keyword=mgr,title={Praca magisterska}]
...
\item [MVC] -- architektura model-widok-kontroler (ang. \english{Model-View-Controller})
\item [MVP] -- architektura model-widok-prezenter (ang. \english{Model-View-Presenter})
\item [MVVM] -- architektura model-widok-model widoku (ang. \english{Model-View-ViewModel})
...
\begin{itemize}
\item źródła programu, które dodatkowo są umieszczone na platformie GitHub\footnote{\url{https://github.com/aleksandrakyc/kanji-learning-app}}
\end{itemize}

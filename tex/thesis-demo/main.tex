...
\item [MVP] -- model--widok--prezenter (ang. \english{Model--View--Prezenter})
\item [MVVM] -- model--widok--viewmodel (ang. \english{Model--View--ViewModel}) %nie znalazłam tłumaczenia

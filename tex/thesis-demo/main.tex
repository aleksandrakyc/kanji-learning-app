...
Do tworzenia aplikacji użyto środowiska Android Studio Giraffe \ksremark{link}. Android Studio to oficjalnie wspierane środowisko programistyczne dla developerów na platformę Android rozwijane przez firmę JetBrains. Zaprezentowane w 2013 roku, niedługo później zastąpiło wcześniej dominujące Eclipse. Android Studio oferuje bogaty wachlarz udogodnień dla programistów, takich jak:
\begin{itemize}
...
Stworzenie tej aplikacji i pracy inżynierskiej jest możliwe dzięki projektowi \href{https://github.com/mifunetoshiro/kanjium}{Kanjium}\ksremark{jak wyżej}. Jest to darmowa baza danych złożona z kilku plików (EDICT, KANJIDIC, KRADFILE) należących do \ksremark{komenda english} Electronic Dictionary Research and Development Group (EDRDG) \ksremark{link}. Informacje na temat partykuł, fonetyki, homonimów, akcentu tonicznego i inne modyfikacje do wyżej wspomnianych plików są autorstwa Urosa Ozvatic \ksremark{Odmieniamy nazwiska.}. Na potrzeby aplikacji opisywanej w tej pracy baza została jedynie okrojona z pewnych niepotrzebnych części \ksremark{np. czego?}, aby jej rozmiar umożliwiał lokalne przechowywanie na urządzeniach użytkowników. Baza danych Kanjium została wykorzystana w tej pracy zgodnie z licencjami grupy EDRDG oraz autora poprawek Urosa Ozvatic \ksremark{odmieniamy}.

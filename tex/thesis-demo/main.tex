...
Użytkownik może uczyć się wybranego zestawu znaków według metody \textit{spaced repetition}, w której najtrudniejsze dla niego znaki będą się pojawiały w najkrótszych interwałach & Ważny \\
...
Przypadki użycia zostały zaprezentowane jako osobne diagramy UML dla każdego z aktorów.
\begin{figure}[h]
\centering
...
%sqlite3
Aplikacja została napisana w języku programowania Java na platformę Android w wersji 10 lub wyższej. 

Do tworzenia aplikacji użyto środowiska Android Studio Giraffe.

Aplikacja byla uruchamiana na emulatorze dostarczonym przez Android Studio modelu Pixel 7.

Dane na temat znaków kanji tylko do odczytu są przechowywane lokalnie jako plik bazy danych sqlite3.
